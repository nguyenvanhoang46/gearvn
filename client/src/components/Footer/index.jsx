    ...
    <div className=''>
      <div className='flex bg-[url("https://theme.hstatic.net/1000026716/1000440777/14/bg-register.png")]  py-[9px] bg-[#dedede] bg-no-repeat gap-96'>
        ...
        <div className="flex items-center ">
          ...
          <span className=''>
							<button className='focus:outline rounded border-[1px]  focus:shadow focus:outline-[#66afe9] h-[30px] py-[5px] px-[10px] text-[12px] rounded-tl-[0px] rounded-bl-[0px]  bg-[#e02626] border-[#ccc] text-[#ffffff] rounded-[3px] ' type="submit">Đăng ký</button>
					</span>
        </div>
      </div>
